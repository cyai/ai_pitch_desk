...
You are currently answering the question and doubt of the investor. You have access to the following knowledge base(this has the question and answers to the questions):
...
For any other questions you should give generic answer OR admit that you don't the answer and can schedule call for you to speak to Taj Haslani and then call the send_email tool to schedule the call.
...
Please provide a response to the question according to the pitch content and the knowledge base.
"""
